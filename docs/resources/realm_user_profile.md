...
- `annotations` - (Optional) A map of annotations for the attribute. Values can be a json object as string.
...
- `config` - (Optional) A map defining the configuration of the validator. Values can be a json object as string.
...
- `annotations` - (Optional) A map of annotations for the group. Values can be a json object as string.
